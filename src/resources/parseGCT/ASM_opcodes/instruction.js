...
export const AA = {
  ...
  Note: The LI and BD fields are sign-extended to 32 bits.`,
    bits: [30],
    displayType: 'boolean',
    validate(value) {return (value === "true" || value === "false" || value == 0 || value == 1);}
};
export const BD = {
    label: "BD",
  ...
  concatenated on the right with 0b00 and sign-extended to 32 bits.`,
    bits: [16, 29],
    displayType: 'hex',
    validate(value) {return parseInt(value, 16) <= 16383;}
};
export const BI = {
    label: "BI",
  ...
  instruction.`,
    bits: [11, 15],
    displayType: 'hex',
    validate(value) {return parseInt(value, 16) <= 16}
};
export const BO = {
    label: "BO",
  ...
  The Programming Environments manual.`,
    bits: [6, 10],
    displayType: 'binary',
    validate(value) {return Object.keys(this.values).includes(value)},
    values: {
...
export const crbA = {
    ...
    validate(value) {return value <= 31},
    prefix: "crb"
...
export const crbD = {
  ...
  instruction.`,
    bits: [6, 10],
    displayType: 'register',
    validate(value) {return value <= 15},
    prefix: "crb"
};
export const crfD = {
    label: "crfD",
...
export const CRM = {
    ...
    bits: [12, 19],
    displayType: 'register',
    validate(value) {return value <= 255},
    prefix: "crm"
};
export const d = (bitType) => {
    return {
        label: "d",
        ...
        validate(value) {return value < 2 ** (this.bits[1] - this.bits[0]) - 1}
    }
};
export const FM = {
    label: "FM",
...
export const LI = {
  ...
  right with 0b00 and sign-extended to 32 bits.`,
    ...
    validate(value) {return -8388608 <= value && value <= 8388607}
};
export const LK = {
    label: "LK",
...
export const MB = {
  ...
  Microprocessor Family: The Programming Environments manual.`,
    bits: [21, 25],
    displayType: 'binary',
    validate(value) {return value <= 0b11111}
};
export const ME = {
    label: "ME",
    description: `These fields are used in rotate instructions to specify a 32-bit mask in the PowerPC
...
export const SIMM = {
    ...
    bits: [16, 31],
    displayType: 'signed_immediate',
    validate(value) {return -32768 <= value && value <= 32767}
};
export const SR = {
    label: "SR",
...
export const UIMM = {
    ...
    bits: [16, 31],
    displayType: 'immediate',
    validate(value) {return value <= 65535}
};
export const XO = (bitType) => {
    return {
        label: "XO",
...
export const target_addr = (bitType) => {
    return {
        label: "target_addr",
